...
criaCartao(
    'Geografia',
    'Em que país se localiza a famosa cidade de Machu Picchu?',
    'Peru.'
)
...
criaCartao(
    'Geografia',
    'Qual é o maior país da América do Sul em área territorial?',
    'Brasil.'
)

criaCartao(
    'História',
    'Em que ano foi declarada a independência dos Estados Unidos?',
    '1776.'
)
...
criaCartao(
    'Arte',
    'Quem pintou o quadro "A Noite Estrelada"?',
    'Vincent van Gogh.'
)
...
criaCartao(
    'Zoologia',
    'Qual o animal terrestre mais rápido do mundo?',
    'Guepardo (ou chita).'
)
...
criaCartao(
    'História',
    'Qual foi o primeiro país a adotar o voto feminino?',
    'Nova Zelândia.'
)

criaCartao(
    'Geografia',
    'Em que cidade fica a sede da ONU?',
    'Nova York.'
)
...
criaCartao(
    'Geografia',
    'Qual país é conhecido como a terra dos mil lagos?',
    'Finlândia.'
)

criaCartao(
    'História',
    'Qual era o nome do Titanic antes de afundar?',
    'RMS Titanic.'
)
...
criaCartao(
    'História',
    'Em qual país nasceu Albert Einstein?',
    'Alemanha.'
)
...
criaCartao(
    ...
    'Deserto da Antártida (em área total).'
)
